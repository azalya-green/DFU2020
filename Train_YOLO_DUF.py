"""
MODIFIED FROM keras-yolo3 PACKAGE, https://github.com/qqwweee/keras-yolo3 and https://github.com/AntonMu/TrainYourOwnYOLO
"""
...
Data_Folder = os.path.join(get_parent_dir(1), "Data_New")
